...
class Google_Service_DLP_GooglePrivacyDlpV2beta2ListJobTriggersResponse extends Google_Collection
{
  protected $collection_key = 'jobTriggers';
  protected $jobTriggersType = 'Google_Service_DLP_GooglePrivacyDlpV2beta2JobTrigger';
