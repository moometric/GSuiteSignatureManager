...
Merge fields are in the following format **{{mergeFieldOne}}**. If you're not sure what merge fields you can use, use *[listMergeFields()](#See-a-list-of-available-merge-tags)* function to view a list of available merge tags.
